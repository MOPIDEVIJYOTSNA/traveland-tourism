...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Enter Hotel Name">
...
<td> <c:out value="${hotel.category}"></c:out>   </td>
...
<img src='displayhotelimage?id=${hotel.id}' width="20%" height="20%"> 
